package com.fluxenture.core.shared.security.config;

import com.fluxenture.core.shared.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200", "http://192.168.0.92:4200", "https://fluxenture.web.app")); // Permitir el origen del frontend

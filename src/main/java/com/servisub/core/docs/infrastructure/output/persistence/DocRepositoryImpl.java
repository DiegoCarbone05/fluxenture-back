package com.servisub.core.docs.infrastructure.output.persistence;

import com.servisub.core.docs.domain.Doc;
import com.servisub.core.docs.domain.DocRepository;
import com.servisub.core.docs.infrastructure.output.persistence.entity.DocEntity;
import com.servisub.core.docs.infrastructure.output.persistence.mapper.DocMapper;
